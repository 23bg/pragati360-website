    ...
    return (
        <div className=" bg-background">
            ...
            <div className="container mx-auto px-4 py-16 max-w-3xl">
                <h1 className="text-h1 font-bold text-foreground mb-12">Privacy Policy</h1>

                <div className="space-y-12">
                    <section>
                        <h2 className="text-h3 font-bold text-foreground mb-4">1. Introduction</h2>
                    ...
                    <section>
                        <h2 className="text-h3 font-bold text-foreground mb-4">2. Information We Collect</h2>
                    ...
                    <section>
                        <h2 className="text-h3 font-bold text-foreground mb-4">3. Use of Your Information</h2>
                        <p className="text-secondary leading-relaxed mb-3">
                    ...
                    <section>
                        <h2 className="text-h3 font-bold text-foreground mb-4">4. Disclosure of Your Information</h2>
                        <p className="text-secondary leading-relaxed">
                    ...
                    <section>
                        <h2 className="text-h3 font-bold text-foreground mb-4">5. Security of Your Information</h2>
                        <p className="text-secondary leading-relaxed">
                    ...
                    <section>
                        <h2 className="text-h3 font-bold text-foreground mb-4">6. Contact Us</h2>
                        <p className="text-secondary leading-relaxed">
