  ...
  return (
    <div className="container mx-auto px-4 py-16 max-w-4xl">
      ...
      <section className="mb-16">
        <h2 className="text-h2 font-bold mb-6">{t('whatToExpect.headline')}</h2>
      ...
      {/* Who Should Apply */}
      <section className="mb-16">
        <h2 className="text-h2 font-bold mb-6">{t('whoShouldApply.headline')}</h2>
        <ul className="space-y-3">
          {['point1', 'point2', 'point3', 'point4'].map((key) => (
            <li key={key} className="flex items-start gap-2">
              <span className="text-primary mt-1">✓</span>
      ...
      {/* Form */}
      <section className="mb-16">
        <h2 className="text-h2 font-bold mb-8">{t('form.headline')}</h2>
      ...
      <section className="mb-16 bg-secondary p-8 rounded-lg">
        <h2 className="text-h2 font-bold mb-6">{t('afterYouApply.headline')}</h2>
        <ul className="space-y-3">
