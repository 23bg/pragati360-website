    ...
    <section className="py-16 sm:py-24 bg-background">
      <div className="container mx-auto px-4 text-center">
        ...
        <div className="mt-12 max-w-3xl mx-auto space-y-8 text-left">
          ...
          <div>
            <h2 className="text-h3 font-bold text-foreground mb-4">{t('multiplePlatforms.title')}</h2>
            <p className="text-body text-muted-foreground">
          ...
          <div>
            <h2 className="text-h3 font-bold text-foreground mb-4">{t('independentSuccessFailure.title')}</h2>
            <p className="text-body text-muted-foreground">
          ...
          <div>
            <h2 className="text-h3 font-bold text-foreground mb-4">{t('noSilentPartialSuccess.title')}</h2>
            <p className="text-body text-muted-foreground">
