    ...
    return (
        <div className=" bg-background">
            ...
            <div className="container mx-auto px-4 py-16 max-w-3xl">
                <h1 className="text-h1 font-bold text-foreground mb-12">Terms & Conditions</h1>

                <div className="space-y-12">
                    <section>
                        <h2 className="text-h3 font-bold text-foreground mb-4">1. Agreement to Terms</h2>
                    ...
                    <section>
                        <h2 className="text-h3 font-bold text-foreground mb-4">2. Use License</h2>
                    ...
                    <section>
                        <h2 className="text-h3 font-bold text-foreground mb-4">3. Disclaimer</h2>
                        <p className="text-secondary leading-relaxed">
                    ...
                    <section>
                        <h2 className="text-h3 font-bold text-foreground mb-4">4. Limitations</h2>
                        <p className="text-secondary leading-relaxed">
                    ...
                    <section>
                        <h2 className="text-h3 font-bold text-foreground mb-4">5. Accuracy of Materials</h2>
                        <p className="text-secondary leading-relaxed">
                    ...
                    <section>
                        <h2 className="text-h3 font-bold text-foreground mb-4">6. Links</h2>
                        <p className="text-secondary leading-relaxed">
                    ...
                    <section>
                        <h2 className="text-h3 font-bold text-foreground mb-4">7. Modifications</h2>
                        <p className="text-secondary leading-relaxed">
                    ...
                    <section>
                        <h2 className="text-h3 font-bold text-foreground mb-4">8. Governing Law</h2>
                        <p className="text-secondary leading-relaxed">
                            These terms and conditions are governed by and construed in accordance with the laws of the jurisdiction
                            in which we are located, and you irrevocably submit to the exclusive jurisdiction of the courts in that
                            location.
                        </p>
                    </section>

                    <section>
                        <h2 className="text-h3 font-bold text-foreground mb-4">9. Contact Information</h2>
                        <p className="text-secondary leading-relaxed">
                            If you have any questions about these Terms & Conditions, please contact us:
                        </p>
                        <div className="mt-4 p-4 bg-muted rounded">
                            <p className="text-foreground font-semibold">Legal Team</p>
                            <p className="text-secondary">Email: legal@company.com</p>
