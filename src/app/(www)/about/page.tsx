    ...
    return (
        <div className="py-20">
            <div className="container mx-auto px-4 text-center">
                <h1 className="text-h1 font-bold mb-4">{t('headline')}</h1>
            ...
            <div className="container mx-auto px-4 mt-12 max-w-3xl">
                ...
                <h2 className="text-h2 font-bold mb-4 text-center">{t('whyExists.title')}</h2>
                <p className="text-muted-foreground mb-8 text-lg leading-8">
                    {t('whyExists.body')}
                </p>

                <h2 className="text-h2 font-bold mb-4 text-center">{t('whoBuiltFor.title')}</h2>
                <p className="text-muted-foreground mb-8 text-lg leading-8">
                    {t('whoBuiltFor.body')}
                </p>

                <h2 className="text-h2 font-bold mb-4 text-center">{t('whatAvoids.title')}</h2>
