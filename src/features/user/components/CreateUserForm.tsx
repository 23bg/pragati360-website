...
const createUserSchema = z.object({
    ...
    isNotificationEnable: z.boolean(),
    isWhatsappAlertsEnable: z.boolean(),
    isEmailAlertsEnable: z.boolean(),
    preferredTheme: z.string().optional(),
    businessRoles: z.array(z.object({
        businessId: z.string(),
...
export default function CreateUserPage() {
    ...
    const form = useForm<CreateUserForm>({
        ...
        defaultValues: {
            ...
            isWhatsappAlertsEnable: false,
            isEmailAlertsEnable: true,
            preferredTheme: "dark",
            businessRoles: [],
        },
    });
